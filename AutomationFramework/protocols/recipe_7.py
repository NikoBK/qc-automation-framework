...
def run(protocol: protocol_api.ProtocolContext):
 # Load labware
    ...
    p20.transfer(20, cartridge['A2'], cartridge['A3'])
    p20.transfer(10, cartridge['B2'], cartridge['B3'])
    p20.transfer(20, resorvoir_green['A1'], cartridge['A3'])
    p20.transfer(20, resorvoir_green['A1'], cartridge['B3'])

...
def run(protocol: protocol_api.ProtocolContext):
 # Load labware
    ...
    p300.transfer(300, HPLC["A1"], HPLC["A4"])
    p300.transfer(300, HPLC["A1"], HPLC["C1"])
    p300.transfer(300, HPLC["A1"], HPLC["C4"])
    p20.transfer(20, resorvoir_blue["A1"],HPLC["C1"])
    p300.transfer(100, resorvoir_green["A1"], HPLC["A4"])
    p300.transfer(100, resorvoir_red["A1"], HPLC["C4"])

...
def run(protocol: protocol_api.ProtocolContext):
 # Load labware
    ...
    p300.transfer(300, HPLC["A3"], HPLC["A4"])
    p300.transfer(100, HPLC["A3"], HPLC["A4"])
    p20.transfer(20, resorvoir_blue["A1"], HPLC["A4"])
    p300.transfer(80, resorvoir_red["A1"], HPLC["A4"])

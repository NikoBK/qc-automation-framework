...
def run(protocol: protocol_api.ProtocolContext):
 # Load labware
    ...
    p300.transfer(200, HPLC["B1"], HPLC["C2"])
    p300.transfer(100, HPLC["B1"], HPLC["C4"])
    p20.transfer(20, resorvoir_blue["A1"], HPLC["C2"])
    p300.transfer(40, resorvoir_green["A1"], HPLC["C4"])

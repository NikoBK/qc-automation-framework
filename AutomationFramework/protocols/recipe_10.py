...
def run(protocol: protocol_api.ProtocolContext):
 # Load labware
    ...
    p20.transfer(10, cartridge["A1"], cartridge["A3"])
    p20.transfer(10, cartridge["A1"], cartridge["A4"])
    p20.transfer(10, cartridge["B1"], cartridge["A3"])
    p20.transfer(10, cartridge["C1"], cartridge["A4"])

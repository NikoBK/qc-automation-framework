...
namespace AStar_test
{
    public static class Routines
    {
        ...
        public static bool XbotIdle(int xbot)
        {
            XBotStatus xBotStatus = _xbotCommand.GetXbotStatus(xbot);
        ...
        public static PointF GetXbotPos(int xbot)
        {
            int[] IDs = GetIds();
            ...
            return new PointF((float)xbotPos.XPos, (float)xbotPos.YPos);
        }

        public static int[] GetXbotGridPoint(int xbot)
        {
            int[] point = new int[2];
            int[] IDs = GetIds();
            int xbotIndex = Array.IndexOf(IDs, xbot);
